...
<div id="tooplate_content">
   ...
   <a href="{{route('evento',[$event->id])}}"><img src="images/event/{{ $event->image }}" alt="{{ $event->image }}" width="250" height="128" class="image_frame" /></a>
   <h5><em>Data:<b>{{date("d/m/Y", strtotime($event->dataOra))}}</b>   Ora:<b>{{date("H:i", strtotime($event->dataOra))}}</b></em></h5>
    <br>
