...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
         ...
         DB::table('events')->insert([
             ...
             'descrizione' => 'Nonostante le grandi difficoltà organizzative,siamo lieti di annunciare lo scontro piu atteso dell anno, migliaia di partecipanti previsti nel rispetto delle normative  ',
             'raggiungere' =>'in macchina:autostrada A14 uscita  Ancona stadio

             in aereo: Areoporto Falconara poi in auto fino Ancona stadio',
             'prezzo' => 25,'bigliettiDisponibili' => 500,
             'bigliettiVenduti' => 0,'incassoTotale' => 0,'sconto' => 15,'insconto' => 1,'regione' => 'Marche','image' => 'ancona.png','admin' => 5,'societa'=>'Eventstore'],
            ['nomeEvento' => 'Alianz Milano-NBV Verona','categoria' => 'Pallavolo', 
             ...
             'bigliettiVenduti' => 0,'incassoTotale' => 0,'sconto' => 20,'insconto' => 0,'regione' => 'Lombardia','image' => 'milano.png','admin' => 5,'societa'=>'Eventstore'],
             ...
             'bigliettiVenduti' => 0,'incassoTotale' => 0,'sconto' => 25,'insconto' => 0,'regione' => 'Emilia-Romagna','image' => 'italia-volley-belgio.jpg','admin' =>7 ,'societa'=>'pallavoloStore'],
            ...
            ['nomeEvento' => 'Sassuolo-Atalanta','categoria' => 'Calcio', 
             ...
             'bigliettiVenduti' => 0,'incassoTotale' => 0,'sconto' => 17,'insconto' => 0,'regione' => 'Emilia-Romagna','image' => 'sassuolo.jpg','admin' => 5,'societa'=>'Eventstore'],
            ['nomeEvento' => 'Turchia-Italia','categoria' => 'Calcio', 
             ...
             'bigliettiVenduti' => 0,'incassoTotale' => 0,'sconto' => 15,'insconto' => 1,'regione' => 'Lazio','image' => 'Tuekey_Italia.jpeg','admin' => 6,'societa'=>'footballStore'],
             ...
             'bigliettiVenduti' => 0,'incassoTotale' => 0,'sconto' => 30,'insconto' => 1,'regione' => ' Trentino-Alto Adige','image' => 'trento.png','admin' => 5,'societa'=>'Eventstore'],
             ...
             'bigliettiVenduti' => 0,'incassoTotale' => 0,'sconto' => 20,'insconto' => 0,'regione' => 'Lombardia','image' => 'grecia-italia-tv.png','admin' => 8,'societa'=>'basketStore'],
             
        ]);
        DB::table('users')->insert([
            ['name' => 'Alex', 'surname' => 'Verdi', 'email' => 'alex@verdi.it', 'username' => 'adminadmin',
                'password' => Hash::make('KrKlkHkR'), 'role' => 'amm','created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),'societa'=>null],
            ['name' => 'Marco', 'surname' => 'Bianchi', 'email' => 'marco@bianchi.it', 'username' => 'clieclie',
                'password' => Hash::make('KrKlkHkR'), 'role' => 'user', 'created_at' => date("Y-m-d H:i:s"),
                'updated_at' => date("Y-m-d H:i:s"),'societa'=>null],
            ...
            ['name' => 'giulio', 'surname' => 'richetti', 'email' => 'mario@bianchi.it', 'username' => 'giuliogiulio',
                ...
                'updated_at' => date("Y-m-d H:i:s"),'societa'=>null],
            ['name' => 'Mario', 'surname' => 'Rossi', 'email' => 'mario@rossi.it', 'username' => 'orgaorga',
                'password' => Hash::make('KrKlkHkR'), 'role' => 'admin', 'created_at' => date("Y-m-d H:i:s"),
        ...
        DB::table('faq')->insert([
            ['domande' => 'per quali eventi è possibile pronotare?',
                
                'risposte' =>'è possibile acquistare biglietti per eventi sportivi delle società aderenti alle nostre politiche, ricercandoli nella
                 nostra sezione catalogo attraverso la ricerca per società ',],
            
            ['domande' => 'come inserisco il tag html per la visualizzazione della mappa?',
                
                'risposte' =>'ricerca la posizione del tuo evento all interno di google maps, utilizza il pulsante di condivisione della posizione e seleziona
                tag html, successivamente copia il valore presente all interno di src="___"(ricordati di eliminare le virgolette iniziali e finali) ',]
       ]);
    }
}
